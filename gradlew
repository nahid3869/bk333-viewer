...
# Collect all arguments for the java command, stracks://github.com/gradle/gradle/raw/v8.5.0/gradlew
...
#   * Put the arguments in a shell array to preserve whitespace
set -- \
